...
class GetUnrackedFilesUseCase implements UseCase<List<FileEntity>, void> {
  final FileRepository _fileRepository;

  GetUnrackedFilesUseCase(this._fileRepository);

  @override
  Future<List<File>> call({void params}) { // TODO: FIX THIS
    return _fileRepository.getFiles(params!);
  }
}
