...
class ChangeTagColorUseCase implements UseCase<void, ChangeTagColorUseCaseParams> {
  final TagRepository _tagRepository;

  ChangeTagColorUseCase(this._tagRepository);

  @override
  Future<Either<Failure, void>> call({required ChangeTagColorUseCaseParams params}) async {
    return await _tagRepository.changeTagColor(tag: params.tag, color: params.colorCode);
  }
}
...
class ChangeTagColorUseCaseParams {
  ...
  ChangeTagColorUseCaseParams({required this.tag, required this.colorCode});
}
